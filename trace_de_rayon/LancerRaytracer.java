...
public class LancerRaytracer {
    ...
    public static void main(String args[]){
        ...
        String fichier_description="trace_de_rayon/simple.txt";
        ...
        // Affichage de l'image calculée partie supérieur gauche
        disp.setImage(image, x0, y0);


        // Affichage de la partie inférieur droite de l'image
        image = scene.compute(l/2, h/2, l/2, h/2);
        disp.setImage(image, l/2, h/2);
    }	
}
